package com.jawsware.interactiveoverlay;
...
import com.example.everpresentwindow.R;
...
public class SampleOverlayView extends OverlayView {
	...
	public SampleOverlayView(OverlayService service) {
		super(service, R.layout.interactive_overlay, 1);
	}
	...
	protected void onInflateView() {
		info = (TextView) this.findViewById(R.id.text_view);
  }
